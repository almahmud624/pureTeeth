            ...
            <div className="flex min-h-screen bg-white">
                <div className="md:w-1/2 max-w-lg mx-auto px-4 py-5 shadow-none">
                    ...
                    <form onSubmit={handleRegistration} className="p-0">
                        ...
                        <div className="mt-10">
                            <input onClick={handleRegistration} type="submit" value="Sign up with email" className="py-2 bg-green-500 text-white font-semibold w-full rounded hover:bg-green-600" />
                        </div>
                    </form>
                    <div>
