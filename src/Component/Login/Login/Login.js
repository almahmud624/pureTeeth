            ...
            <div className="flex min-h-screen bg-white">
                <div className="md:w-1/2 max-w-lg mx-auto px-4 py-5 shadow-none">
                    ...
                    <form onSubmit={handleLogin} className="p-0">
                        ...
                        <div className="mt-4">
                            <input onClick={handleEmailPasswordLogin} type="submit" value="Login" className="py-2 bg-green-500 text-white w-full rounded hover:bg-green-600 text-lg font-semibold" />
                        </div>
                    </form>
